...
$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_fe.php']['contentPostProc-output'][] = 'EXT:fe_facelifting/view/class.tx_fefacelifting_contentpostproc.php:tx_fefacelifting_contentpostproc->includeJavaScript';
